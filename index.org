...
*** 2022-09-28, Bonus assignment

To receive extra credit (see Description/Grading for precise grading
scheme) we encourage you to work in pairs to make a 5-10-minute video
...
You can find an overview of Haskell packages on [[http://hackage.haskell.org/][Hackage]] and of
language extensions in [[http://downloads.haskell.org/~ghc/latest/docs/html/users_guide/exts.html][the GHC documentation]].

If you have a package or extension in mind that you would like to make
a video about, please contact [[mailto:F.Staals@uu.nl][Frank Staals]] or [[mailto:m.i.l.vakar@uu.nl][Matthijs Vákár]] to ensure
that the choice is appropriate.

You can find more information and some examples for the Bonus
assignment [[file:optional.html][here]].
