---
title: INFOFP 2026-2027 Functional Programming
---
...
There will be a midterm and a final exam. The exams are closed
book, and focus on "pen-and-paper" type programming questions.
...
- [[./labs.html][Small practical assignments]] pose programming problems with the aim
  of practicing your Haskell skills. These assignments are
  automatically corrected by [[https://prairielearn.science.uu.nl][PrairieLearn]], and are graded
  pass/fail. You can ask any of the teaching assistants to suggest
  improvements to your code style during labs sessions.

- The [[./labs.html][final programming project]] consists of programming a small game
  in Haskell. *You will have to do this assignment in pairs*. The
  project will be pass/fail, but you can gain up to 0.8 bonus points
  for your final grade.

* Grading

Note that the grading rules have changed this year (2026-2027). The
final grade almost entirely depends on the two exams. In particular:

- the midterm grade M which counts for 30% of the grade,
- the final exam grade F which counts for the remaining 70% of the grade.

Additionally,

- you will need to pass at least 2 out of the 3 small practical
  assignments.

- the final programming project can gain you at most 0.4 bonus points P for the
  process and at most 0.4 bonus points R for the result.

Your final grade will be computed as min(0.3*M + 0.7*F + P + R, 10).

To pass the course

   - the weighted average of the midterm and the final needs to be at least a 5,
   - you need to pass the final programming assignment, and
   - you need to pass at least 2 small practical assignments.

To qualify for the retake exam:

  - your weighted average of the midterm and the final needs to be at least a 4,
  - you need to pass the final programming assignment, and
  - you need to pass at least one small practical assignment.

You cannot retake the final programming assignment.

* AI Policy

Any form of AI help in their assignments is *not* allowed: the [[https://www.uu.nl/en/organisation/ai-policy/students/ai-index][AI
Index]] for Functional Programming is 1. You are expected to rely on
your own understanding, reasoning ability and skills to complete the
work in the course.
...
'ghcup'. In particular, you can follow [[https://www.haskell.org/ghcup/][these]] instructions to install
'ghc' and 'cabal'.  It does not matter too much which version of GHC
you install; sticking to the "recommended" versions by ghcup should
suffice.
