...
and a list ~inits~ of vertices as inputs and produces a list of all the directed paths of maximal length in ~someGraph~ that start from a vertex ~i~ in ~inits~.
